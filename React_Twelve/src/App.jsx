  ...
  <div className="mx-auto max-w-7xl px-6 py-10 sm:px-10 lg:px-14">
    ...
    <nav className="mb-20 flex items-center justify-between">
      ...
      <div className="hidden items-center gap-8 text-xs font-medium text-zinc-500 sm:flex">
        <span className="cursor-pointer text-zinc-900">Collection</span>
        <span className="cursor-pointer transition hover:text-violet-600">
          New Arrivals
        </span>
    ...
    <section className="mb-16 grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:items-end">
      ...
      <div>
        <p
          className="mb-5 text-xs font-semibold uppercase tracking-[0.3em] text-violet-600"
